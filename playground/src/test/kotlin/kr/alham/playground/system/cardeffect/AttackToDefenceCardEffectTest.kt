...
import kr.alham.playground.system.calculator.DamageCalculatorDefault
...
class AttackToDefenceCardEffectTest{
    ...
    fun setUp(){
        ...
        attackToDefenceCardEffect = AttackToDefenceCardEffect(cardValueCalculator,damageCalculator)
